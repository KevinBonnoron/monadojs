...
export const NUMBER_OBJECT_MAP = new Map(OBJECT_ARRAY.map((value, index) => [index, value]));
export const STRING_OBJECT_MAP = new Map(OBJECT_ARRAY.map((value) => [value.name, value]));
