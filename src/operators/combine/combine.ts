...
export function combine<A, B, C, D, E, F>(o1: Operator<A, B>, o2: Operator<A, C>, o3: Operator<A, D>, o4: Operator<A, E>, o5: Operator<A, F>): Operator<A, [B, C, D, E, F]>;
export function combine<A, B, C, D, E, F, G>(o1: Operator<A, B>, o2: Operator<A, C>, o3: Operator<A, D>, o4: Operator<A, E>, o5: Operator<A, F>, o6: Operator<A, G>): Operator<A, [B, C, D, E, F, G]>;
export function combine<T>(...operators: Operator<unknown, unknown>[]) {
